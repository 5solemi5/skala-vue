...
**1. 하는 일 고르기**
화면 맨 위에서 정비 / 농사 / 현장 / 운동 중 하나를 고른다.
...
같은 날씨가 정비에는 `주의`, 현장에는 `양호` 인 것을 한눈에 볼 수 있다.
...
색은 작업 중지 / 주의 / 양호 세 가지에만 썼다. 화면에서 색이 보이는 곳 = 신경 쓸 곳.

**판정은 아이콘이 아니라 글자로.**
`중지`와 `주의`는 아이콘만으로 구분되지 않는다. 테두리 친 글자로 표시했다.

**결정 순서대로 배치했다.**
처음에는 검색 / 내 지역 / 모드 / 목록이 전부 같은 크기의 상자로 쌓여 있었다.
무엇부터 봐야 하는지 알 수 없어서, 실제 판단 순서인
`어떤 일을 하는가 → 그래서 오늘 뭘 해야 하는가 → 다른 지역은 어떤가` 로 다시 세웠다.
