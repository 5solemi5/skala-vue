...
<template>
  <div class="dashboard-wrapper">
    ...
    <section class="search-box">
      ...
      <p class="search-result">
        <span v-if="searchQuery"
          >검색 중인 도시: <strong>{{ searchQuery }}</strong></span
        >
    ...
    <section class="mode-box">
      ...
      <p class="summary">
        <span v-if="alertCityCount > 0"
          >⛔ 지금 보이는 지역 중 <strong>{{ alertCityCount }}곳</strong>은 오늘 작업을 미루시는
          편이 낫습니다.</span
        >
    ...
    <section class="list-box">
      ...
      <div class="card-grid">
        ...
        >
          ...
          <ul class="metric">
            <li>
              <span>습도</span><b>{{ item.humidity }}%</b>
            </li>
            <li>
              <span>강수확률</span><b>{{ item.rainProb }}%</b>
            </li>
            <li>
              <span>최저기온</span><b>{{ item.minTemp }}℃</b>
            </li>
          </ul>
          ...
          <div class="advice-box">
            ...
            <div
              v-for="(advice, index) in adviceMap[item.id]"
              :key="index"
              class="advice"
              :class="advice.level"
            >
